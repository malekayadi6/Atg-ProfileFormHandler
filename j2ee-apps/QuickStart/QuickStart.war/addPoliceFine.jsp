...
<dsp:importbean bean="/atg/userprofiling/ProfileFormHandler"/>
		...
		<div class="col-sm-9">
		<!-- column 2 -->	
       <h3><i class="glyphicon glyphicon-dashboard"></i> Add PoliceFine</h3>  
      ...
      <div class="form-group">
          ...
          <div class="form-group">
            ...
            <dsp:input type="hidden" bean="PoliceFineFormHandler.value.user.repositoryId"  beanvalue="ProfileFormHandler.repositoryId" />
                        
           <label class="col-md-3 control-label"></label>
            <div class="col-md-8">
            <div class=" row spacing-row"></div>
              <dsp:input bean="PoliceFineFormHandler.create" type="submit" class="btn btn-primary" value="Add PoliceFine" />
               <dsp:input bean="PoliceFineFormHandler.cancel"  type="reset" class="btn btn-default" value="Cancel"/>
               <dsp:input bean="PoliceFineFormHandler.createSuccessURL" type="hidden" value="detailUser.jsp"/>
            </div>
    </dsp:form>
