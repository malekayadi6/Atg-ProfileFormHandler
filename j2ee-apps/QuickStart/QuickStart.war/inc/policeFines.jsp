...
<dsp:importbean bean="/quickstart/RepositoryFormHanlder/PoliceFineFormHandler"/>
   ...
   <ul class="list-group">
		<li style="padding-bottom: 20px" class="list-group-item text-muted "><i class="glyphicon glyphicon-tags"> PoliceFine Items </i>   
                ...
                <td>
                    ...
                    <dsp:form action="<%=request.getRequestURI()%>" method="post">
                      <dsp:input type="hidden"  bean="PoliceFineFormHandler.repositoryId"  paramvalue="element.repositoryId"/>
                              ...
                              <dsp:input bean="PoliceFineFormHandler.deleteSuccessURL" type="hidden" value="detailUser.jsp"/>
                    </dsp:form>
                </td>
               </tr>      
</dsp:oparam>
